...
class CanvasStreamer {
    constructor(divToPlayIn, useWorker, webgl, targetCanvas) {
    ...
    start() {
        if (!window.player) {
            ...
            window.player = new Player({
                ...
                webgl: this.webgl,
                size: { width: playerElement.innerWidth, height: playerElement.innerHeight },
            ...
            // window.player.canvas.setAttribute('disabled', true);
